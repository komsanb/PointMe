...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Drawable directionIcon = resources.getDrawable(R.drawable.direction_icon);
        ...
        final TabHost.TabSpec directionTab = tabHost.newTabSpec("direction");
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                if (tabId.equals("direction")) {
                    ...
                    Intent intent = new Intent(getApplication(), Directions.class);
                    startActivity(intent);
                }
